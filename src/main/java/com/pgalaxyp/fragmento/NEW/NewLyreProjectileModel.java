...
public class NewLyreProjectileModel<T extends Entity> extends EntityModel<T> {

    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(
                    ResourceLocation.fromNamespaceAndPath("modid", "new_lyre_projectile"),
                    "main"
            );
    ...
    public NewLyreProjectileModel(ModelPart root) {
