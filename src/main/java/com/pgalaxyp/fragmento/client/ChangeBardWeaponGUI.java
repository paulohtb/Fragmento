...
public class ChangeBardWeaponGUI extends Screen {
    private final Item[] items;
    private double rotation = 0;
    private int hover = -1;

    public ChangeBardWeaponGUI(Item[] inputItems, Item selected) {
    ...
    public static boolean canOpen() {
        ...
        return mc.player != null && mc.player.getMainHandItem().getItem() instanceof AbstractBardWeapon;
    }
}