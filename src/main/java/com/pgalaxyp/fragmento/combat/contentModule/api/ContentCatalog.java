...
public record ContentCatalog(Map<AbilityId, AbilityDefinition> abilities, Map<EffectId, EffectDef> effects, List<AbilityRule> abilityRules, Map<WeaponId, AbilityId> primaryBindings) {
    ...
    public static ContentCatalog of(List<? extends ContentPack> packs) {
        ...
        return new ContentCatalog(abilities, effects, rules, primary);
    }
