...
import com.pgalaxyp.fragmento.combat.events.ability.AbilityResolved;
...
public final class SkillResolutionSystem implements FrameSystem {
    private final SkillResolver resolver;
    private final ComboService combos;

    public SkillResolutionSystem(SkillResolver resolver, ComboService combos) {
