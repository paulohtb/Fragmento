...
public final class FragmentoServerRuntimeRegistry {
    ...
    public static void remove(MinecraftServer server) { RUNTIMES.remove(Objects.requireNonNull(server)); }
    ...
    private static Runtime createRuntime(MinecraftServer server) {
        ...
        WorldCommandPort world = new CompositeWorldCommandPort(List.of(new McDamageWorldCommandAdapter(damagePort)));
