...
public record HomingMagicVisualEvent(long frameId, int localIndex, ActorId sourceActorId, ActorId targetActorId, int lifetimeFrames) implements DomainEvent {
