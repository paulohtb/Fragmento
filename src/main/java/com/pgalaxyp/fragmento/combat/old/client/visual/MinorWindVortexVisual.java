...
public final class MinorWindVortexVisual {
    ...
    public MinorWindVortexVisual(
        ...
        int loopsMinusOne = this.loops - 1;
    ...
    private float getTime(Minecraft mc, float partialTick) {
        ...
        return (float) (now - startGameTime) + partialTick;
    }
    ...
    private AnimationState computeAnimationState(float globalTime) {
        ...
        for (int i = 0; i < loops; i++) {
            ...
            if (globalTime >= (float) startI && globalTime < (float) endI) {
                float local = globalTime - (float) startI;
    ...
    private record AnimationState(boolean active, float localTime, boolean converging, float convergePhase,
                                  boolean lifting, float liftPhase, float alphaMul, float yOffset) {
