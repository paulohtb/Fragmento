...
public class HerculesAngel extends AbstractAngel implements GeoEntity {

    public HerculesAngel(EntityType<? extends Mob> type, Level level) {
        super(type, level);
    }

    public HerculesAngel(Level level, LivingEntity owner) {
        super(EntitiesRegistry.HERCULES_ANGEL.get(), level, owner);
    }
