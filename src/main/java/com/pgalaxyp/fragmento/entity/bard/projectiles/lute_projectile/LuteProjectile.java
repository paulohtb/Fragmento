package com.pgalaxyp.fragmento.entity.bard.projectiles.lute_projectile;
...
public class LuteProjectile extends AbstractProjectile implements GeoEntity {
    ...
    public LuteProjectile(EntityType<? extends Projectile> type, Level world) {
        super(type, world);
    }
    ...
    protected void onHit(HitResult hitResult) {
        ...
        if (hitResult.getType() == HitResult.Type.ENTITY) {
            ...
            if (hitedEntity instanceof LivingEntity living) {
                ...
                if (isCharged()) {
                    living.addEffect(new MobEffectInstance(EffectsRegistry.SLEEP, 20, 0));
                }
            }
        }
