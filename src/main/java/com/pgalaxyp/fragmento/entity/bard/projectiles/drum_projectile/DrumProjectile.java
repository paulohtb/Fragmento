package com.pgalaxyp.fragmento.entity.bard.projectiles.drum_projectile;
...
public class DrumProjectile extends AbstractProjectile implements GeoEntity {
    ...
    private static final EntityDataAccessor<Boolean> IS_CHARGED =
            SynchedEntityData.defineId(DrumProjectile.class, EntityDataSerializers.BOOLEAN);
    ...
    public DrumProjectile(EntityType<? extends Projectile> type, Level world) {
        super(type, world);
    }
