...
public class ApolloAngel extends AbstractAngel implements GeoEntity {

    public ApolloAngel(EntityType<? extends Mob> type, Level level) {
        super(type, level);
    }

    public ApolloAngel(Level level, LivingEntity owner) {
        super(EntitiesRegistry.APOLLO_ANGEL.get(), level, owner);
    }
