...
public class ViolinProjectile extends AbstractProjectile implements GeoEntity, FinalComboAware {

    private static final EntityDataAccessor<Boolean> IS_CHARGED =
            SynchedEntityData.defineId(ViolinProjectile.class, EntityDataSerializers.BOOLEAN);
    ...
    public ViolinProjectile(EntityType<? extends Projectile> type, Level world) { super(type, world); }

    public ViolinProjectile(Level world, LivingEntity shooter, boolean charged) {
