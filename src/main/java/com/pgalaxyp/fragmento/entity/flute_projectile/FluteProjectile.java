...
public class FluteProjectile extends AbstractProjectile implements GeoEntity {
    ...
    private static final EntityDataAccessor<Boolean> IS_CHARGED = SynchedEntityData.defineId(FluteProjectile.class, EntityDataSerializers.BOOLEAN);
    ...
    public FluteProjectile(EntityType<? extends Projectile> type, Level world) { super(type, world); }
        ...
        if (hitResult.getType() == HitResult.Type.ENTITY) {
            ...
            if (hit instanceof Mob mob) {
                ...
                if (isCharged()) {
                    ...
                    mob.addEffect(new MobEffectInstance(EffectsRegistry.CHARMED, 200, 0));
