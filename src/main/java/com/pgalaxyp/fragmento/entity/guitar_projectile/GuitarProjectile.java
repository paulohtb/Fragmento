package com.pgalaxyp.fragmento.entity.guitar_projectile;
...
public class GuitarProjectile extends AbstractProjectile implements GeoEntity {

    private static final EntityDataAccessor<Boolean> IS_CHARGED = SynchedEntityData.defineId(GuitarProjectile.class, EntityDataSerializers.BOOLEAN);
    ...
    public GuitarProjectile(EntityType<? extends Projectile> type, Level world) { super(type, world); }

    public GuitarProjectile(Level world, LivingEntity shooter, boolean charged) {
