...
public final class RedCube8Model implements CosmeticModel {
    ...
    private static void quad(
        ...
        v(vc, pose, light, overlay, x1, y1, z1, nx, ny, nz);
        v(vc, pose, light, overlay, x2, y2, z2, nx, ny, nz);
        v(vc, pose, light, overlay, x3, y3, z3, nx, ny, nz);
        v(vc, pose, light, overlay, x4, y4, z4, nx, ny, nz);
    }
