...
public final class InstantActionExecutor implements ActionExecutor {

    @Override
    public boolean supports(ActionDefinition definition) {
        Objects.requireNonNull(definition, "definition cannot be null");

        return definition.type() == ActionType.INSTANT && definition.plan() instanceof SingleActionPlan;
    }
    ...
    public ActionRuntime create(ActionDefinition definition) {
        ...
        return new InstantActionRuntime(definition);
    }
}